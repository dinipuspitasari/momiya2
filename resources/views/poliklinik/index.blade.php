...
@section('title', 'Momiya Medical Clinic | Poliklinik')
...
@section('content')
    ...
    <div class="col">
        <h2 class="mt-2 text-xl mb-1 font-semibold"> Data Poliklinik</h2>
        <hr>
    </div>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-900 px-10 ">
            <thead class="text-xs text-white uppercase bg-gray-900 h-8">
                <tr align="center">
                    ...
                    <th class="border border-gray-300 px-2 py-2">Nama Poliklinik</th>
                ...
                @foreach ($polikliniks as $u)
                    <tr align="center" class="bg-white border-b text-gray-900">
                        ...
                        <td class="flex items-center justify-center py-2 px-2">
                            ...
                            <a href={{ url('/poliklinik/delete/' . $u->id) }}
