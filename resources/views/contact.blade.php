...
{{-- navigation bar end --}}
  ...
  <!-- Contact Section -->
  <section class="py-24 md:px-[24px]">
    <h1 class="text-4xl font-bold text-center mb-8">CONTACT US</h1>
    <div class="container mx-auto grid md:grid-cols-2 gap-8 md:px-24 px-10">
        <!-- Contact Form -->
        <div class="bg-gray-800 p-8 rounded-lg">
            ...
            <form action="#" method="POST" class="space-y-4">
                <div>
                    ...
                    <input type="text" id="name" name="name" class="w-full p-3 rounded-lg bg-gray-700 border border-gray-600 text-white" placeholder="Your Name">
                </div>
                <div>
                    <label for="email" class="block mb-2 text-sm">Email</label>
                    <input type="email" id="email" name="email" class="w-full p-3 rounded-lg bg-gray-700 border border-gray-600 text-white" placeholder="example@youremail.com">
                </div>
                <div>
                    <label for="subject" class="block mb-2 text-sm">Subject</label>
                    <input type="text" id="subject" name="subject" class="w-full p-3 rounded-lg bg-gray-700 border border-gray-600 text-white" placeholder="Title">
                </div>
                <div>
                    <label for="message" class="block mb-2 text-sm">Message</label>
                    <textarea id="message" name="message" rows="4" class="w-full p-3 rounded-lg bg-gray-700 border border-gray-600 text-white" placeholder="Type Here..."></textarea>
                </div>
                <button type="submit" class="w-full py-3 bg-orange-500 text-white font-semibold rounded-lg hover:bg-orange-600">Send Now</button>
            </form>
        </div>
        ...
        <div class="space-y-4">
            ...
            <div>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d942.6534587361466!2d106.77992006954923!3d-6.145141399615117!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f736fd14d86d%3A0xfc697f87eafdb2fd!2sMomiya%20Medical%20Clinic!5e1!3m2!1sid!2sid!4v1728959575178!5m2!1sid!2sid" width="100%" height="300" class="rounded-lg"></iframe>
            </div>
        </div>
    </div>
</section>
