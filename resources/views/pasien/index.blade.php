...
@section('title', 'Momiya Medical Clinic | Admin')
            ...
            <tbody>
                @foreach ($users as $u)
                    <tr align="center" class="bg-white border-b text-gray-900">
                        ...
                        <td class="border border-gray-300 px-2 py-2">{{ $u->name }}</td>
                        <td class="border border-gray-300 px-2 py-2">{{ $u->email }}</td>
                        <td class="border border-gray-300 px-2 py-2">{{ $u->updated_at }}</td>
                        <td class="flex items-center justify-center py-2 px-2">
                            <a href={{ url('/user/edit/' . $u->id) }} type="button"
